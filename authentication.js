// with help from http://voidcanvas.com/node-js-googleapis-v4-spreadsheet/
...
const TOKEN_PATH = TOKEN_DIR + 'sheets.getRedBoxes.json'; //the file which will contain the token
